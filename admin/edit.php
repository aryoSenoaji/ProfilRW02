...
$datawrg = query("SELECT * FROM data_warga WHERE id = $id")[0];
...
<div class="height-100 bg-light">
    ...
    <input type="hidden" name="id" value="<?= $datawrg["id"]; ?>">
    <div class="col-md-6">
            <label for="namaRt" class="form-label">Nomor Rt</label>
            <input type="text" class="form-control" name="namaRt" id="namaRt" value="<?= $datawrg["rt"]; ?>">
        </div>
        <div class="col-12">
            <label for="linkGd" class="form-label">Link Data Warga</label>
            <input type="text" class="form-control" name="linkGd" id="linkGd" value="<?= $datawrg["link"]; ?>">
        </div>
