...
<div class="height-100 bg-light">
    ...
    <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="namaRt" id="namaRt" placeholder="001-012">
        </div>
        <div class="col-12">
            <label for="linkGd" class="form-label">Link Data Warga</label>
            <input type="text" class="form-control" name="linkGd" id="linkGd" placeholder="Masukan Link Google Drive">
        </div>
