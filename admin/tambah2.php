...
<div class="height-100 bg-light">
    <h2 class="text-center mb-5">Tambah Link Video Youtube</h2>
    <form class="row g-3" action="" method="post">
        <div class="col-md-6">
            <label for="ketVideo" class="form-label">Keterangan Video</label>
            <input type="text" class="form-control" name="ketVideo" id="ketVideo" placeholder="Keterangan Video Youtube">
        </div>
        <div class="col-12">
            <label for="linkVideo" class="form-label">Link Data Warga</label>
            <input type="text" class="form-control" name="linkVideo" id="linkVideo" placeholder="Masukan Link Video Youtube">
        </div>
